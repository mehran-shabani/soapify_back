...
class TestDownloadAPKView:
    ...
    @patch("crazy_miner.telemedicine_views.os.path.exists", return_value=True)
    @patch("crazy_miner.telemedicine_views.open", create=True)
    @patch("crazy_miner.telemedicine_views.APKDownloadStat.objects.only")
    @patch("crazy_miner.telemedicine_views.apk_downloaded.send")
